 ...
 * adding and updating of projects uses Project#isSameProject(Project) for equality so as to ensure
 * that the project being added or updated is unique in terms of identity in the UniqueProjectList.
 * However, the removal of a project uses Project#equals(Object) so
